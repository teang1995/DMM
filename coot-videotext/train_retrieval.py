...
def main():
    ...
    parser.add_argument("--is_baseline", type=str, default=True, help="if true use baseline else use mixup")
    ...
    for run_number in range(1, args.num_runs + 1):
        ...
        trainer = Trainer(
            ...
            load_epoch=args.load_epoch, load_model=args.load_model, inference_only=args.validate, is_baseline=args.is_baseline)
