...
do
for m2mix_type in pos_jm both_jm
do
for beta in 1.0 2.0
do
...
#         model.beta_params=$beta model.single_mix=$uni model.all_mix=$all model.multi_mix=$mm model_train.batch_size=128 model_train.temperature=$temperature model.m2mix_type=$m2mix_type
