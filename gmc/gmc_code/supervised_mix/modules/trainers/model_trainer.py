...
class ModelLearner(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Forward
        loss, tqdm_dict = self.model.training_step(data, target_data, self.train_config, self.cur_ep)
    ...
    def training_epoch_end(self, outputs):
        #! tracking ep for mix scheduling
        self.cur_ep += 1
    ...
    def validation_step(self, batch, batch_idx):
        ...
        output_dict = self.model.validation_step(data, target_data, self.train_config, self.cur_ep)
