...
CUDA_VISIBLE_DEVICES=4 python main_unsupervised.py \
-f with experiment.stage="train_model" experiment.model="mmix_l_05" \
        experiment.seed=$seed experiment.log_name="label" experiment.use_label=True \
        model.model="mmix_l_05" model.dirichlet_params=[0.5,0.5,0.5,0.5] model.mixup_type="replace" \
        model_train.epochs=100 down_train.epochs=100

CUDA_VISIBLE_DEVICES=4 python main_unsupervised.py \
-f with experiment.stage="train_downstream_classfier" experiment.model="mmix_l_05" \
        experiment.seed=$seed experiment.log_name="label" experiment.use_label=True \
        model.model="mmix_l_05" model.dirichlet_params=[0.5,0.5,0.5,0.5] model.mixup_type="replace" \
        model_train.epochs=100 down_train.epochs=100

CUDA_VISIBLE_DEVICES=4 python main_unsupervised.py \
-f with experiment.stage="evaluate_downstream_classifier" experiment.model="mmix_l_05" \
        experiment.seed=$seed experiment.log_name="label" experiment.use_label=True \
        experiment.evaluation_mods=[0] \
        model.model="mmix_l_05" model.dirichlet_params=[0.5,0.5,0.5,0.5] model.mixup_type="replace" \
        model_train.epochs=100 down_train.epochs=100
