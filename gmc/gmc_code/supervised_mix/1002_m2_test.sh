...
-f with experiment.scenario="mosei" experiment.stage="train_model" \
        experiment.model="mmix_${uni}_${all}_${mm}_${temperature}_${beta}_${m2mix_type}" model.model="mmix_${uni}_${all}_${mm}_${temperature}_${beta}_${m2mix_type}" model_train.epochs=2 experiment.seed=$seed \
