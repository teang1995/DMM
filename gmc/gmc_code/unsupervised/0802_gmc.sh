...
-f with experiment.stage="train_model" experiment.model="gmc_nl" \
        experiment.seed=$seed experiment.log_name="0803_no_label" experiment.use_label=False model.model="gmc_nl" \
...
-f with experiment.stage="evaluate_downstream_classifier" experiment.model="gmc_nl" \
        ...
        model.model="gmc_nl" model_train.epochs=100 down_train.epochs=50
