...
from gmc_code.supervised_mix.data_modules.class_dataset import *
from gmc_code.supervised_mix.architectures.models.gmc import AffectGMC
from gmc_code.supervised_mix.modules.trainers.dca_evaluation_trainer import DCAEvaluator


def setup_model(scenario, model_config, tot_ep):
    return AffectGMC(
...
def load_model(sacred_config, model_file):
    ...
    model = setup_model(
        ...
        tot_ep=sacred_config["model_train"]["epochs"]
    )
